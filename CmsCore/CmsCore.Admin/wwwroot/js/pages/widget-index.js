var initTable1 = function () {
    ...
    table.dataTable({
        ...
        "bServerSide": true,
        "bProcessing": true,
        "sAjaxSource": "/Widget/AjaxHandler",
        ...
        "columnDefs": [{  // set default column settings
                ...
                'render': function (data, type, row) {
                    return '<div class="btn-group"><button class="btn btn-xs green dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">Eylemler<i class="fa fa-angle-down"></i></button>'
                        ...
                        + '<a href="/Widget/Delete/' + row[0] + '" onclick="if (!confirm(\'Bu kaydı silmek istediğinize emin misiniz? Bu işlem geri alınamaz.\')) return false;"><i class="icon-ban"></i> Sil</a></li></ul></div>';
                }
            }
        ],
